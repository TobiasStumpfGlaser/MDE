...
/**
 * DEPRECATED: Diese Tests wurden in separate Dateien verschoben:
 * - ArtNrHelperTest.kt
 * - BuchungsHelperTest.kt (erweitert)
 * - ServerResponseParserTest.kt (erweitert)
 * - DataRepositoryTest.kt
 *
 * Dieser File bleibt nur für Legacy-Kompatibilität und sollte nicht erweitert werden.
 */
